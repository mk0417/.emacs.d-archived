...
(with-eval-after-load 'evil
  ...
  (define-key evil-normal-state-map (kbd "tf")   'xah-forward-right-bracket)
  (define-key evil-normal-state-map (kbd "tb")   'xah-backward-left-bracket)
  (define-key evil-normal-state-map (kbd "tF")   'xah-replace-paren-to-bracket)
  (define-key evil-normal-state-map (kbd "tP")   'xah-replace-bracket-to-paren)
  (define-key evil-normal-state-map (kbd "tt")   'xah-replace-true-to-false)
  (define-key evil-normal-state-map (kbd "tT")   'xah-replace-false-to-true)
